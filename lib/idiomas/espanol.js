...
//_antiprivado 
const smsprivado = () => { return `*no conecta al privado*\n\n*.*`}
...
const smsCreC = () => { return 'Siempre a disposición para ayudar'}
...
//info-contacto.js
const smsContacto1 = () => { return ' Soy ' + packname + ' un Bot de WhatsApp dedicado en ayudar con lo que pueda'}
...
const smsConVIDEO3 = () => { return lenguajeGB.smsAvisoEG() + '*✓*'} 
...
//config.js
const smsWait = () => { return '*Por favor espere...*'}
...
//grupo-tagall.js
const smstagaa = () => { return `⚡Invocando a todos`}
...
//_allantilink.js 
const smsTextoYT = () => { return ' EmetBot - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
//menu-menu.js
const smsMenuTotal1 = () => { return "INFO MENÚ"}
...
const smsyFBvid6 = () => { return 'VÍDEO DE FB DESCARGADO '}
