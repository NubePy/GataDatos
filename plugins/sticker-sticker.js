...
if (stiker) {
conn.sendFile(m.chat, stiker, 'sticker.webp', '', null, false, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: packname, body: '', mediaType: 2}}})
} else {
